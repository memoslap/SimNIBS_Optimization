...
isSimNIBS4xx = int(__version__[-1])>0 and isSimNIBS4
isSimNIBS402 = int(__version__[-1])>1 and isSimNIBS4
if isSimNIBS4:
...
def _relabel_internal_air(m, label_skin = 1005, label_new = 1099):
